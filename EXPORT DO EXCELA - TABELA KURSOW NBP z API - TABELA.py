...
total_content = []
# zastąpienie tworzenia nagłówka za pomocą zmiennej poźniejszym określaniem w DataFrame za pomocą 'header' 
...
custom_headers = ['WALUTA','KOD','KURS WALUTY z dnia: ' + data_do_url]

# Zapisujemy arkusz do pliku
tekst = (r"C:/Praktyczny_Python/ROBOCZE/tabela kursów NBP z dnia "+str(data_do_url)+".xlsx")
df.to_excel(tekst,sheet_name='NBP z '+str(data_do_url), index=False, header=custom_headers)
